# Generated by Django 5.2.14 on 2026-06-06 19:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0004_alter_securitylog_event_type'),
    ]
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        ...
                        'Excecao de conflito de escala aprovada',
                    ),
                    (
                        'volunteer_schedule_access',
                        'Acesso de voluntario a escala (magic-link)',
                    ),
                ],
                db_index=True,
                max_length=40,
